<%-- 
    Document   : homepagePagination
    Created on : 23 Ιαν 2019, 12:36:37 πμ
    Author     : Tasos
--%>
...
ul {
  ...
  li:last-child a {
    ...
    <script>
        ...
        document.getElementById('pagination').innerHTML = createPagination(pages, 20);
        ...
        for (let p = pageCutLow; p <= pageCutHigh; p++) {
            ...
            active = page == p ? "active" : "no";
            str += '<li class="page-item '+active+'"><a href="pagination/'+p+'.htm" onclick="createPagination(pages, '+p+')">'+ p +'</a></li>';
        }
